![](https://img.shields.io/badge/Live%20Project%207-Product%20Home%20page-brightgreen)
...
- This project taught me how to position different elements on top of each other, how to use drop shadow property to give the shadow illusion across an image's outline and using circles as list bullets. A very well thought of aesthetically beautiful build.
...
***
## **🔥Netlify Live Link🔥**
- [Product Home Page](https://live-proj-7-fullstackjsbootcamp.netlify.app/)

&nbsp;
***
## **📷 Post Designing Screenshot 📷**
![](https://github.com/manikD1/Live-Project-7-Product-Home-Page/blob/main/Actual-Screenshot.JPG)
